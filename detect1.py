...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
            ...
            if save_img:
                ...
                if x < 13: 
                    ...
                    if x == last:
                      ...
                      cv2.putText(im0,sum_avg,(5,100), cv2.FONT_HERSHEY_COMPLEX_SMALL,2,(0,0,255),1) ## Show text
                    # obj = []
                  # else:  
        ...
        with open(write_dir, mode='w') as obj_file1: 
            writer = csv.writer(obj_file1, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
